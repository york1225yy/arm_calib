#!/usr/bin/env python3
"""
09_pick_and_estimate_nuts_mujoco.py
---------------------------------
...
--------
  ...
  python 09_pick_and_estimate_nuts_mujoco.py --viewer

  # 无图形界面/自动化测试：自动模拟按键 'e' 后持续跟踪+打印
  python 09_pick_and_estimate_nuts_mujoco.py --no_gui --auto --save_video output_3nuts/pose_estimation_vision.mp4
"""
